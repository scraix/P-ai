...
- 新增（remote-im-contact-thread-beta）：远程 IM 联系人后台会话测试版（尚未完善）
  - 联系人支持按处理部门自动路由：主部门默认进入主会话，非主部门默认进入该联系人的独占后台会话
  - 联系人后台会话归联系人持有，切换处理部门时保留原有后台线程历史，不再因为路由切换清空会话绑定
  - 后端新增隐藏联系人会话查询与消息查看接口，归档窗口新增“联系人消息”页签用于查看后台联系人线程
  - `remote_im_send` 新增 `no_reply`，隐藏联系人线程强制要求模型通过回复工具做出 `发送/不回复` 决策
